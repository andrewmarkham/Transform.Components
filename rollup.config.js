...
libConfig.output = [
  { sourcemap: true, name: 'Transform.Components', file: 'dist/transform.components.cjs.js', format: 'cjs' },
  { sourcemap: true, name: 'Transform.Components', file: 'dist/transform.components.es.js', format: 'es' },
];
*/
/*
  UMD CONFIG
...
umdFullConfig.output = [
  { globals: globals(), sourcemap: true, name: 'Transform.Components', file: 'dist/transform.components.full.js', format: 'umd' },
];
...
umdFullConfigMin.output = [
  { globals: globals(), sourcemap: true, name: 'Transform.Components', file: 'dist/transform.components.full.min.js', format: 'umd' },
];
...
umdConfig.output = [
  { globals: allGlobals, sourcemap: true, name: 'Transform.Components', file: 'dist/transform.components.js', format: 'umd' },
];

const umdConfigMin = baseUmdConfig(true);
umdConfigMin.external = external;
umdConfigMin.output = [
  { globals: allGlobals, sourcemap: true, name: 'Transform.Components', file: 'dist/transform.components.min.js', format: 'umd' },
];
